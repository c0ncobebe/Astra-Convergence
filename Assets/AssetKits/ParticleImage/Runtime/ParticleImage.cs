...
namespace AssetKits.ParticleImage
{
    ...
    public sealed class ParticleImage : MaskableGraphic
    {
        ...
        private RectTransform _currRectTrans;

        public RectTransform CurrRectTrans
        {
            get
            {
                if (_currRectTrans == null)
                    _currRectTrans = this.transform.GetComponent<RectTransform>();
                return _currRectTrans;
            }
            private set => _currRectTrans = value;
        }
        ...
        [SerializeField]
        private UnityEvent _onAnyParticleSpawned = new UnityEvent();
        /// <summary>
        /// Called when any piece of a particle spawn.
        /// </summary>
        public UnityEvent onAnyParticleSpawned => _onAnyParticleSpawned;
        /// <summary>
        ...
        private void OnAnyParticleSpawned()
        {
            onAnyParticleSpawned.Invoke();
        }
